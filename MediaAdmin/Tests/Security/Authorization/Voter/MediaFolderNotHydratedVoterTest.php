...
use OpenOrchestra\MediaAdmin\Security\Authorization\Voter\MediaFolderNotHydratedVoter;

/**
 * Class MediaFolderNotHydratedVoterTest
 */
class MediaFolderNotHydratedVoterTest extends AbstractVoterTest
{
    /**
     * Set up the test
     */
    public function setUp()
    {
        ...
        $this->voter = new MediaFolderNotHydratedVoter($this->accessDecisionManager, $this->perimeterManager);
    }
    ...
    protected function getNotSupportedSubjects()
    {
        ...
        return array(
            ...
            'Bad subject : Folder'           => array($folder,      ContributionActionInterface::READ, array(ContributionRoleInterface::DEVELOPER), true, VoterInterface::ACCESS_ABSTAIN),
        );
    }
    ...
    {
        $folder = $this->createNotHydratedFolder();
     ...
     * @return array
     */
    protected function createNotHydratedFolder()
    {
        return array('folderId' => 'fid', 'path' => 'path');
    }
}
