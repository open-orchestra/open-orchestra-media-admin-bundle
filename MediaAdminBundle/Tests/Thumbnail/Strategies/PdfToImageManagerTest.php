...
use OpenOrchestra\MediaAdmin\Thumbnail\Strategies\PdfToImageManager;
use Phake;
...
class PdfToImageManagerTest extends AbstractStrategyTest
{
    ...
    public function setUp()
    {
        ...
        $this->imagick = Phake::mock('OpenOrchestra\MediaAdmin\FileUtils\Image\ImageManagerOldInterface');
